...
await build({ entryPoints: ['extension/src/background.ts', 'extension/src/panel.ts', 'extension/src/popup.ts'], outdir: 'extension/foundation', bundle: true, format: 'esm', target: 'chrome127', sourcemap: true });
