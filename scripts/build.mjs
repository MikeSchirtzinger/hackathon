...
await build({ entryPoints: ['extension/src/background.ts', 'extension/src/panel.ts'], outdir: 'extension/foundation', bundle: true, format: 'esm', target: 'chrome120', sourcemap: true });
