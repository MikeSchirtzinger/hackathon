...
for(const file of [manifest.background.service_worker,'panel.html','foundation/panel.js','index.html','demo.wav','vendor/sherpa-onnx-wasm-web.wasm','vendor/sherpa-onnx-wasm-web.js','vendor/sherpa-onnx-asr.js','vendor/sherpa-onnx-tts.js','vendor/LICENSE','models/kokoro/LICENSE','models/nemotron/Notice.txt','models/nemotron/LICENSE-NVIDIA.pdf']) await access(path.join(root,'extension',file));
let count=0;
